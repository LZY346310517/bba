...
from routes.resets import main as resets_routes
from routes.reply import main as reply_routes
from routes.board import main as board_routes
from routes.message import main as mail_routes
from routes.xiugai import main as xiugai_routes
...
def register_routes(app):
    ...
    app.register_blueprint(xiugai_routes, url_prefix='/xiugai')
    app.register_blueprint(resets_routes, url_prefix='/')
